...
class SavedAddressScreen extends StatefulWidget {
  /// When true, the screen acts as a picker: choosing an address pops back
  /// with the selected [AddressModel]. When false (default) it is a manager.
...
class _SavedAddressScreenState extends State<SavedAddressScreen> {
  ...
  /// Return the currently selected address to the caller (picker mode).
  void _confirmSelection() {
    ...
    selected ??= _addresses.isNotEmpty ? _addresses.first : null;
    if (selected != null) {
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                // In selection mode, a primary "Use this address" action.
                if (widget.selectionMode && _addresses.isNotEmpty) ...[
                  ButtonWidget(
